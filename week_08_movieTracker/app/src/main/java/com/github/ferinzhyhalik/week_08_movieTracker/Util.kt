package com.github.ferinzhyhalik.week08_movieTracker
...
fun convertNumericQualityToString(quality: Int, resources: Resources): String {
    ...
    when (quality) {
        ...
        3 -> qualityString = resources.getString(R.string.two_bad)
...
fun convertStringQualityToNumeric(quality: String, resources: Resources): Int {
    ...
    when (quality) {
        ...
        resources.getString(R.string.two_bad) -> qualityInt = 3
